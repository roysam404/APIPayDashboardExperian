...
public class Xls_Reader {
	...
	public String getTestData(String workBookName, String sheetName, String uniquevalue, String colName) {
		String TEST_DATA_SHEET_PATH = System.getProperty("user.dir") + "/" + "/src/test/resources/testdata/" + workBookName
				+ ".xlsx";
		...
		try {
			...
			int uniqueRow = getCellRowNum(sheetName, "uniqueValue", uniquevalue);
			value = getCellData(sheetName, colName, uniqueRow);
